...
class ControllerBugFix(Controller):
  def __init__(self, *args: Any, **kwargs: Any,):
    ...
    self.cursor_js = resources.read_text('browser_use.custom.js', 'showCursor.js')
    self.highlight_js = resources.read_text('browser_use.custom.js', 'highlightBox.js')
      ...
      try:
        ...
        if download_path:
          ...
          # msg = f'🖱️  Clicked button with index {params.index}: {element_node.get_all_text_till_next_clickable_element(max_depth=2)}'
            msg = f'🖱️  Clicked button with index {params.index}: {element_node.get_all_text_till_next_clickable_element()}'
