from browser_use.dom.service import DomService, DOMState, DOMElementNode, SelectorMap, DOMBaseNode, DOMTextNode
from browser_use.custom.dom_element_zoo import DomElementNodeBugFix
...
class DomServiceBugFix(DomService):
  def __init__(
    ...
    **kwargs: Any,
    ...
    self.js_code = resources.read_text('browser_use.custom.js', 'buildDomTree.js')
...
class DomServiceBlackTransparent(DomServiceBugFix):
  def __init__(
    ...
    **kwargs: Any,
    ...
    super().__init__(*args, **kwargs)
    self.js_code = resources.read_text('browser_use.custom.js', 'buildDomTreeBlackTransparent.js')