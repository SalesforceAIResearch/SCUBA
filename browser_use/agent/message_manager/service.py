...
class MessageManager:
	...
	def add_plan(self, plan: Optional[str], position: int | None = None, as_ai_message: bool = True) -> None:
		if plan:
			if as_ai_message:
	...
	def _remove_last_plan(self) -> None:
		"""Remove last plan from history"""
		self.state.history.remove_last_plan()
