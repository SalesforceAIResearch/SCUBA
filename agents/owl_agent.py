...
def push_oss(image_path):
    ...
    raise NotImplementedError("push_oss is not implemented")
...
def get_image_url(image):
    ...
    # return image_url
    raise NotImplementedError("get_image_url is not implemented")
    ...
    def predict(
        ...
        while True:
            ...
            try:
                ...
                this_task_logger.error(f"Error when fetching response from client, with error: {e}")
                prediction = None
                try_times -= 1
                import time
                time.sleep(1)
