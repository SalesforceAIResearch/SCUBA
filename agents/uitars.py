...
UITARS_NO_CALL_USR_ACTION_SPACE = """
click(start_box='<|box_start|>(x1,y1)<|box_end|>')
left_double(start_box='<|box_start|>(x1,y1)<|box_end|>')
right_single(start_box='<|box_start|>(x1,y1)<|box_end|>')
drag(start_box='<|box_start|>(x1,y1)<|box_end|>', end_box='<|box_start|>(x3,y3)<|box_end|>')
...
class UITARSAgent:
    def __init__(
        ...
        runtime_conf: dict = {
            "infer_mode": "qwen2vl_no_calluser", # all the tasks are solvable without calling the user
        ...
        **kwargs
        ...
        elif self.infer_mode == "qwen2vl_no_calluser":
            self.prompt_action_space = UITARS_ACTION_SPACE
        elif self.infer_mode == "qwen2vl_no_calluser":
            self.prompt_action_space = UITARS_NO_CALL_USR_ACTION_SPACE
    ...
    def predict(
        ...
        last_action_after_obs: Dict = None
    ) -> List:
        """
        ...
        while True:
            ...
            try:
                ...
                this_task_logger.exception(f"Error when fetching response from client, with response: {e}")
                prediction = None
                try_times -= 1
